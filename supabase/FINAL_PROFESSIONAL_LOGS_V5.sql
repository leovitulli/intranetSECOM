...
-- 2. CRIAR A FUNÇÃO DE LOG PRO (SIMPLIFICADA E SEGURA PARA NÃO DAR ERRO DE COLUNA)
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        -- MONITORANDO CAMPOS GARANTIDOS (Título, Descrição, Data, Prioridade)
        ...
        -- MONITORAMENTO DE ANEXOS (USANDO COALESCE PARA SEGURANÇA)
