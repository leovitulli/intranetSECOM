...
-- ATUALIZA A FUNÇÃO RPC create_task_atomic PARA INCLUIR TODOS OS CAMPOS (Sincronizado com o Frontend)
...
DECLARE
    ...
    v_user_name TEXT;
BEGIN
    -- Obter o nome do usuário logado para o log
    ...
    VALUES (v_task.id, auth.uid(), COALESCE(v_user_name, 'Sistema'), 'create', 'Pauta criada via RPC Atômica (Sincronizada com Aba Post)');
