...
-- 2. CRIAR A FUNÇÃO DE LOG DETECTIVE (PROFISSIONAL + FOTOS + RESPONSÁVEIS)
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        -- MONITORAMENTO DE RESPONSÁVEIS
        IF (OLD.responsibles IS DISTINCT FROM NEW.responsibles) THEN
            detail_msg := detail_msg || 'Atualizou a equipe de responsáveis. ';
        END IF;
